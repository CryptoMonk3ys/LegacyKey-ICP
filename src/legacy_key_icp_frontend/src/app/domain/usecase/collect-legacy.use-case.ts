...
export class CollectLegacyUseCase implements UseCase<SaveLegacyParams, void | null> {
  constructor(
  ...
  async execute(params: SaveLegacyParams): Promise<void | null> {
    switch (params.walletChain) {
      case "ethereum":
        return this.ethRepository.withdrawHeir(params.walletAddress, params.idLegacy);
    }
